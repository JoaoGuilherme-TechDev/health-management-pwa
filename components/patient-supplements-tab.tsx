            ...
            <Card key={supplement.id}>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="text-sm text-muted-foreground">
                  <strong>Período:</strong> {new Date(supplement.start_date).toLocaleDateString("pt-BR")}
                  {supplement.end_date && ` até ${new Date(supplement.end_date).toLocaleDateString("pt-BR")}`}
                </div>
