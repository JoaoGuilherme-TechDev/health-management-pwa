-- Create unique constraint on medication_reminders to prevent duplicates
...
-- Update medication reminder processor
...
BEGIN
  ...
  LOOP
    -- Create or get medication_reminder instance
    ...
    -- Insert notification linked to the reminder instance
...
-- Update appointment reminder processor to use related_id
