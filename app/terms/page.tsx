          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                Ao criar uma conta ou utilizar o aplicativo <strong>App Dra. Estefânia Rappelli</strong>, você concorda com estes
                Termos de Serviço e com nossa Política de Privacidade. Caso não concorde com qualquer parte destes termos,
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                O App Dra. Estefânia Rappelli é um aplicativo voltado ao gerenciamento de saúde, permitindo o agendamento e acompanhamento
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-2">
                Você se compromete a utilizar o App Dra. Estefânia Rappelli de forma ética e em conformidade com a legislação aplicável,
                sendo vedado:
              </p>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                O App Dra. Estefânia Rappelli é uma ferramenta de apoio à organização do cuidado em saúde e não substitui, em hipótese
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                utilizarem o App Dra. Estefânia Rappelli para registrar informações sobre pacientes devem agir de acordo com a ética e as
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                O tratamento de seus dados pessoais, incluindo dados de saúde, é regido pela nossa Política de
                  ...
                  Privacidade do App Dra. Estefânia Rappelli.
                </p>
              </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                conteúdos disponibilizados, pertencem ao App Dra. Estefânia Rappelli ou a seus licenciadores, sendo protegidos por leis de
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Na máxima extensão permitida pela legislação aplicável, o App Dra. Estefânia Rappelli não se responsabiliza por danos
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Podemos suspender ou encerrar seu acesso ao App Dra. Estefânia Rappelli a qualquer momento em caso de descumprimento
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                comunicadas por meio do aplicativo ou por outros canais apropriados. O uso contínuo do App Dra. Estefânia Rappelli após a
