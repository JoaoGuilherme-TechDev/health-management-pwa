      ...
      <div className="container mx-auto py-8 px-4 max-w-4xl">
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-2">4. Bases Legais para Tratamento</h2>
              <p className="text-muted-foreground mb-2">O tratamento dos seus dados pessoais pode ocorrer com base em:</p>
              <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                <li>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-2">5. Compartilhamento de Informações</h2>
              <p className="text-muted-foreground mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-2">6. Transferências Internacionais</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-2">7. Segurança das Informações</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-2">8. Retenção de Dados</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-2">9. Seus Direitos</h2>
              <p className="text-muted-foreground mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-2">11. Atualizações desta Política</h2>
              <p className="text-muted-foreground">
